...
export default function DemoPage() {
  ...
  return (
    <div className="min-h-screen min-h-[100dvh] bg-gradient-to-b from-brand-deep via-brand-bar to-brand-warm">
      <header className="mx-auto flex max-w-[min(100vw-2rem,1920px)] flex-nowrap items-center justify-between gap-2 px-4 pb-2 pt-[max(0.75rem,env(safe-area-inset-top))] sm:gap-4 sm:px-6">
      ...
      <main className="mx-auto w-full max-w-[min(100vw-2rem,1920px)] px-4 pb-14 pt-2 sm:px-6 sm:pb-16 sm:pt-4">
        <h1 className="text-center font-heading text-4xl font-bold leading-tight tracking-tight text-brand-amber sm:text-5xl md:text-6xl">
          See it live on a TV or
          <span className="block text-brand-amber-bright sm:mt-1">
            in your browser.
          </span>
        </h1>

        <p className="mx-auto mt-3 max-w-xl text-center text-sm leading-snug text-brand-text sm:mt-4 sm:text-base">
        ...
        <p className="mx-auto mt-4 max-w-lg text-center text-base leading-snug text-brand-muted sm:mt-5 sm:text-lg">
